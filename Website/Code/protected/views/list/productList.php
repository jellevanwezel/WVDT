    ...
    <tbody>
        ...
        if (count($products) > 0) {
            foreach ($products as $productUser) {
                ...
                echo CHtml::closeTag('td');
                echo CHtml::openTag('td');
                echo CHtml::tag('a', array('title'=>'Verwijderen','alt'=>'Verwijderen','class' => 'btn removeProduct pull-right', 'id' => "remove_product_" . $productUser->id), "<span class='glyphicon glyphicon-remove'></span>");
                echo CHtml::closeTag('td');
