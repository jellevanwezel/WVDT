...
class Product extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('qr_code', 'length', 'max'=>128),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, name, price, qr_code', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'productPayments' => array(self::HAS_MANY, 'ProductPayment', 'product_id'),
			'productUsers' => array(self::HAS_MANY, 'ProductUser', 'product_id'),
		);
	}
